...
export default function HistoryPage() {
  ...
  const [filterType, setFilterType] = useState<"all" | "movies" | "series">(
    "all",
  );
  ...
  return (
    <motion.div
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      className="min-h-screen px-6 sm:px-10 md:px-16 lg:px-20 xl:px-28 max-w-[1600px] mx-auto w-full py-4 md:py-8 pb-28 md:pb-8"
    >
      {/* Header */}
      <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 mb-6 md:mb-8">
        <div>
          ...
          <p className="text-sm text-[var(--rf-text-dim)]">
            Keep track of what you've watched, resume unfinished videos, or
            clear lists
          </p>
        </div>
        ...
        <div className="flex flex-col lg:flex-row gap-4 items-center justify-between p-4 rounded-2xl bg-white/[0.02] border border-white/[0.04] mb-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full lg:w-auto">
            ...
            <div className="relative w-full sm:w-60">
              <Search
                size={14}
                className="absolute left-3.5 top-1/2 -translate-y-1/2 text-[var(--rf-text-dim)]"
              />
              <input
                type="text"
                value={searchQuery}
      ...
      {items.length === 0 && (
        ...
        >
          ...
          <p className="text-sm text-[var(--rf-text-dim)] max-w-sm mx-auto leading-relaxed mb-6">
            You haven't watched any movies or TV series yet. Explore our cinema
            library to discover awesome content.
          </p>
          <Link
            to="/explore"
              ...
              return (
                ...
                >
                  <div className="group relative">
                    ...
                    <button
                      onClick={(e) =>
                        handleDeleteItem(e, item.subjectId, item.title)
                      }
